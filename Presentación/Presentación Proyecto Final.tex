...
\begin{frame}{Introdución}
    ...
    \begin{itemize}
        \justifying
        \item Para los ciudadanos, resulta de suma importancia sentirse representados por los demás integrantes de la misma, mediante políticas públicas que abarquen sus necesidades y requerimientos. 
        % \item La toma de datos demográficos y la estadística son dos herramientas primordiales a la hora de identificar requerimientos de los integrantes de una comunidad.
        % \item En el caso particular de Argentina, el Instituto Nacional de Estadística y Censos (INDEC) es el organismo público que ejerce la dirección superior de todas las actividades estadísticas oficiales que se realizan en el país.
        % \item Al adentrarse y estudiar los índices correspondientes a uno de los ejes principales, educación, en un territorio delimitado, Ciudad Autónoma de Buenos Aires, se ha encontrado una gran limitación relacionada con su acceso inequitativo para los diferentes actores de la sociedad. 
...
\begin{frame}{Fuente de información}
    ...
    \begin{figure}
        \centering
        \includegraphics[scale=0.5]{../Informe/Imagenes/GobCiuBsAs.jpg}
    \end{figure}
...
\begin{frame}{Estructura de los trabajos}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Conclusión:} Se alcanzan conclusiones finales sobre los hallazgos.
...
\begin{frame}{Análisis bivariado}
    ...
    \begin{center}
        \includegraphics[scale=0.21]{../Informe/Imagenes/ABCatVsNum3Bis.png}
    \end{center}
...
\begin{frame}{Análisis multivariado}
    ...
    \begin{center}
        \includegraphics[scale=0.17]{../Informe/Imagenes/AMIngVSTargetBis.png}
    \end{center}
