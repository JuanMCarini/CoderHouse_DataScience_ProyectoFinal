...
% \begin{frame}{Análisis bivariado}
    ...
    \begin{center}
        \includegraphics[width=13cm, height=4cm]{../Informe/Imagenes/ABCatVsNum3Bis.png}
    \end{center}
...
% \noindent
    \begin{figure} 
        \includegraphics[scale=0.177]{../Informe/Imagenes/AMIngVSTargetBis.png}
    \end{figure}
...
\begin{frame}{Modelos analíticos}
    ...
    Al utilizar random forest  hemos podidos mejorar el sesgo y disminuir el underfitting en 2 puntos porcentuales aproximadamente.
