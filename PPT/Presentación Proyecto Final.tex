...
% \author[Data Science]{\textbf{Profesor:} Damian Dapueto \\ \textbf{Tutor:} Héctor Alonso }

% \date{\textbf{Grupo de Trabajo:} Lucia Buzzeo, Lucia Hukovsky,\\ Jose Saint German, Juan Martín Carini}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[scale=0.2]{Imagenes/Coder.png}
    \end{center}
