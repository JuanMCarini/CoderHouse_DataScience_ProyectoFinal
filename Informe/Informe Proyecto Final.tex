...
\section{Introducción a las variables: Análisis exploratorio de los datos}
    ...
    \caption{Anlálisis preliminar de variables del dataset.}
    ...
    Durante el apartado de análisis univariado se han aunado esfuerzos para analizar las variables de manera aislada. El foco principal se ha puesto en definir las variables que aportan información sobre los individuos que forman parte del dataset.
        \subsubsection{Género y edad}
            ...
            \begin{figure}[H]
                ...
                \caption{Analisis de genero y edad.}
    ...
    \subsection{Análisis bivariado}
        ...
        \begin{figure}[H]
            ...
            \caption{Correlación entre variables por metodo de Spearman.}
        ...
        En concreto, la principal correlación positiva es ``años\_escolaridad'' con ingreso familiar per cápita (``ing\_per\_cap\_familiar''), lo cual hace sentido teórico.
...
\vspace{1cm}
            A su vez, se presenta otro heat map que reune en un unico gráfico el promedio de años de escolaridad por comuna. Este gráfico refuerza la relalción presentada en la figura anterior.
            ...
            A partir de los úlimos dos gráficos se ha establecido una clara división geográfica del nivel educativo:
            \begin{itemize}
    ...
    \subsection{Análisis multivariado}
        ...
        A su vez, se ha buscado relacionar el Taget, con los ingresos y el dominio.
 
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.255]{Imagenes/AMIngVSTargetBis.png}
            \caption{Relacion entre dominio, Target e ingresos familiares}
        ...
        \begin{figure}[H]
            ...
            \caption{Relacion entre comuna, Target e ingresos familiares}
