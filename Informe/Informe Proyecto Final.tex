...
\vspace{1cm}
            ...
            \begin{table}[!ht]
                ...
                \end{tabular}
                \caption{Matriz de confusión segundo modelo.}
                \label{Second model confusion matriz}
            \end{table}
...
\vspace{1cm}
           ...
           Esto ha mostrado que el mejor árbol de decisión posible obtiene 0.642. Para alcanzarlo, el árbol debe tener una profundidad de  6, utilizar  10  variables y usar el método ``gini''.
            ...
            \begin{table}[H]
                ...
                \end{tabular}
                \caption{Matriz de confusión segundo modelo mejorado.}
                \label{Neww Second model confusion matriz}
            \end{table}
    ...
    \subsection{Random Forest Classifier}
        ...
        \subsubsection{Tercer modelo}
            ...
            \begin{table}[H]
                ...
                \end{tabular}
                \caption{Matriz de confusión tercer modelo}
                \label{Thrid model cofusion matrix}
            \end{table}
        ...
        \subsubsection{Cuarto modelo}
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{rrrrr}
                    ...
                    \bottomrule
                \end{tabular}
                \caption{Matriz de confusión cuarto modelo}
                \label{Fourth model cofusion matrix}
            \end{table}
           ...
           Como parte de los resultado, el mejor random forest posible ha obtenido 0.668. 
            ...
            \begin{table}[!ht]
                ...
                \begin{tabular}{rrrrr}
                    ...
                    weighted avg & 0.65 & 0.62 & 0.59 & 3967 \\
                \end{tabular}
                \caption{Matriz de confusión cuarto modelo mejorado.}
                \label{New foruth model confusion matrix}
            \end{table}
