...
\section{Modelos analíticos}
    ...
    \subsection{Tratados de nulos}
        ...
        \subsubsection{Variables reemplazadas con moda}

    \subsection{Target}

        \subsubsection{Borrado de variables}
    
    \subsection{División de train y test}

        \subsubsection{Trian}

            \paragraph{One Hot Encoding}

            \paragraph{División de X e Y}
        ...
        \subsubsection{Test}
            ...
            \paragraph{Comparación de cantidad de columnas}
    
    \subsection{Buscando el mejor modelo}
