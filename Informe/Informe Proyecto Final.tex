...
\section{Introducción}
    ...
    \subsection{Objetivos del proyecto}
        ...
        % COMENTARIO DE HECTOR. Añadir el objetivo del modelo de clasificación, así como los modelos implementados.
        ...
        \begin{itemize}
            ...
            \item \textbf{Bosque Aleatorio:} es un conjunto (ensemble) de árboles de decisión combinados con bagging.
        \end{itemize}
...
\section{Modelos analíticos}
    ...
    \subsection{Árbol de decisión}
        ...
        \subsubsection{Segundo modelo}
            ...
            Esta vez al correr el modelo, utilizaremos el ``DecisionTreeClassifier'' solo con los parametros:
            \begin{itemize}
                \item random\_state = 50,
            ...
            \begin{itemize}
                \item \textbf{Bias o sesgo:} 99.78\% que nos indica que tengo poco error. $\Rightarrow$ low bias,
                \item \textbf{Variance=Test\_Score - Bias=} 46.39\% $\Rightarrow$ high variance,
            \end{itemize}
            
            Lo que nos da como resultado, que noesto modelo esta haciendo \textbf{OVERFITTING}.
        ...
        \subsubsection{Gridsearch con CV}
            ...
            Y nos da como resultado, que el mejor arbol de decisión posible obtiene 0.642. Y para eso el arbol debe tener una profundidad de  6, utilizar  10  variables y usar el método ``gini''.
    ...
    \subsection{Random Forest Classifier}
        ...
        \subsubsection{Primer modelo}
            ...
            \end{table}
             ...
             El random forest performa bastante bien, con, muchi mejor que los modelos anteriores:
             \begin{itemize}
                \item \textbf{Bias o sesgo:} 97.80\% que nos indica que tengo bastantes errores $\Rightarrow$ high bias,
                \item \textbf{Variance=Test\_Score - Bias==} 7.20\%  $\Rightarrow$ low variance.
             \end{itemize}
             
             De todas maneras buscamos cuales son las variables más importantes, y encontramos que los años de escolaridad redujo la enorme importancia (a un 43.58\%) que tenía en el random tree. Sin embargo, sigue correspondiendo quitarla del modelo.
        ...
        \subsubsection{Segundo modelo}
            ...
            \begin{itemize}
                \item \textbf{Bias o sesgo:} 89.11\% que nos indica que tengo bastantes errores $\Rightarrow$ high bias,
                \item \textbf{Variance=Test\_Score - Bias==} 27.4\%  $\Rightarrow$ low variance.
             \end{itemize}

            El modelo empeora su accuracy pero está muy cercano al mejor modelo de Random Tree, miestras que crece mucho la varianza a un 27.4\% (unos 20 puntos). Ahora, al igual que con el el DesicionTree, vamos a probar mejorándolo con grid search.
        ...
        \subsubsection{Gridsearch con CV}
            ...
            Y para eso el arbol debe tener una profundidad de  15 , utilizar  10  variables, tener  300  estimadores y utilizar el método ``gini''.
            ...
            \begin{itemize}
                ...
                \item \textbf{Variance=Test\_Score - Bias:} 28.54\% $\Rightarrow$ high variance
            \end{itemize} 
...
\section{Conclusiones}
    ...
    \begin{table}[H]
        ...
        \hline
            ...
            arbol\_default & 0.5339 & 0.9978 & 0.4639 \\ \hline
            arbol\_mejorado & 0.6012 & 0.6527 & 0.0514 \\ \hline
    ...
    \begin{itemize}
        ...
        \item Por el contrario, el arbol mejorado tiene una varianza insuperable de 5\%, aunque con el menor puntaje con respecto al sesgo.
    ...
    \end{itemize}
    Como era de esperarse, los finalistas son el arbol y el bosque mejorado. Sorprendentemente, ambos performan muy bien pero en étricas diferentes. A su vez, el accuracy de ambos difiere en apenas un 2%.
